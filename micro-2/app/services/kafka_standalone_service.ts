...
/**
 * Service Kafka standalone pour micro-2
...
class KafkaStandaloneService {
  ...
  constructor() {
    this.kafka = new Kafka({
      clientId: kafkaConfig.clientId || 'micro-2',
   ...
   */
  async createConsumer(topic: string, groupId: string, handler: (data: any) => Promise<void>): Promise<void> {
